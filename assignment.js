...
function TriangleArea(side1,side2,side3) {
    let area = 1/2*side1*side2;
    console.log(area);
    alert(`area is equals to ${area}`);
}
...
//5. Write a function to swap pairs of adjacent digits of a given integer of
even length.
...
console.log("The biggest even number in the array is: "+BigEven());
...
function deleteProperty(obj, property) {
  ...
  const updatedStudent = deleteProperty(student, "rollno");
  console.log("After deleting the property:", updatedStudent);
